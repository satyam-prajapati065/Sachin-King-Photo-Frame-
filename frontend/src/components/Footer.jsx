...
import { Phone, Mail, MapPin, MessageCircle, Frame, Sparkles, Heart, ChevronRight } from 'lucide-react';

export default function Footer() {
  const phoneNumber = '+91 7052668517';
  const whatsappUrl = 'https://wa.me/917052668517?text=Hello%20Sachin%20King%20Photo%20Frame,%20I%20want%20to%20know%20more.';
    ...
    <footer className="bg-[#0b0b0e] text-amber-200/80 border-t border-amber-500/20 pt-16 pb-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-amber-500/15">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-amber-200/70 leading-relaxed font-poppins">
              "Ek Hi Chhat Ke Neeche Photo Framing Ki Sabhi Suvidhayein" - Providing premium wooden framing, lamination, god frames, wedding portraits, canvas printing, and commercial printing services.
            </p>
            ...
            <ul className="space-y-2 text-xs">
              {[
                ...
                <li key={link.path}>
                  ...
                  >
                    <ChevronRight className="w-3 h-3 text-amber-500/60" /> {link.name}
                  </Link>
                </li>
              ))}
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              {[
                ...
                <li key={idx} className="flex items-center gap-1.5 py-0.5 text-amber-200/80">
                  <span className="w-1.5 h-1.5 rounded-full bg-amber-400/60" /> {service}
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3 text-xs">
              <div className="flex items-start gap-2.5">
                ...
                <span>Main Shop Road, Near City Center, Photo Framing Hub, Uttar Pradesh, India</span>
              </div>

              <div className="flex items-center gap-2.5">
                <Phone className="w-4 h-4 text-amber-400 shrink-0" />
                <a href={`tel:${phoneNumber}`} className="hover:text-amber-300 transition-colors">
                  +91 7052668517
                </a>
              </div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href="mailto:sp073643@gmail.com" className="hover:text-amber-300 transition-colors">
                  sp073643@gmail.com
                </a>
              </div>
              ...
              <div className="pt-2">
                <a
                  href="https://maps.google.com/?q=Photo+Framing+Shop"
                  target="_blank"
                  rel="noreferrer"
        ...
        <div className="pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-amber-400/60 text-center">
          <p>© {new Date().getFullYear()} Sachin King Photo Frame. All rights reserved.</p>
          <p className="flex items-center justify-center gap-1">
            Crafted with <Heart className="w-3.5 h-3.5 text-red-500 fill-red-500 inline" /> for Premium Quality & Customer Satisfaction
          </p>
        </div>
      </div>
    </footer>

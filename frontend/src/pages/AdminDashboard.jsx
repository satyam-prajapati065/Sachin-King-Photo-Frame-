...
export default function AdminDashboard() {
    ...
    try {
      ...
      setSettingsStatus({
        ...
        message:
          ...
          "Failed to update credentials. Please verify current password.",
      });
    } finally {
  ...
  if (authLoading || (!isAuthenticated && !loading)) {
    return (
      <div className="py-20 text-center text-amber-400">Authenticating...</div>
    );
  }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="flex flex-wrap gap-2 border-b border-amber-500/20 pb-4">
        {[
          ...
          {
            id: "testimonials",
            name: `Reviews (${testimonials.length})`,
            icon: MessageSquare,
          },
        ...
        <div className="space-y-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 rounded-2xl glass-card border border-amber-500/20 space-y-2">
              ...
              <h3 className="text-3xl font-bold font-playfair text-amber-100">
                {services.length}
              </h3>
              <p className="text-[11px] text-amber-200/60">
                Framing, printing & gift options
              </p>
            </div>
          ...
          <div className="p-6 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-xs text-amber-200/80 space-y-2">
            <h4 className="font-bold text-amber-300 text-sm">
              💡 Quick Management Tip:
            </h4>
            <p>
              Use the tabs above to add new services, update prices, upload
              frame gallery photos, delete outdated items, or check incoming
              contact inquiries directly from your phone or desktop.
            </p>
          </div>
        </div>
      )}
            ...
            {gallery.map((item) => (
              ...
              >
                ...
                <div className="flex justify-between items-start gap-2">
                  <div>
                    <h4 className="font-bold text-amber-200 text-xs font-playfair">
                      {item.title}
                    </h4>
              ...
              {messages.map((msg) => (
                ...
                >
                  <div className="space-y-1 text-xs">
                    ...
                    <p className="text-amber-100/90 leading-relaxed font-poppins pt-1">
                      {msg.message}
                    </p>
        ...
        <div className="max-w-2xl mx-auto space-y-6">
          <div className="p-6 sm:p-8 rounded-3xl glass-card border border-amber-500/30 space-y-6">
            ...
            <form onSubmit={handleUpdateSettings} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-amber-200 flex items-center gap-1.5">
                  <Lock className="w-3.5 h-3.5 text-amber-400" /> Current
                ...
                <p className="text-[10px] text-amber-300/60">
                  Required to confirm authorization.
                </p>
              </div>
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-amber-200 flex items-center gap-1.5">
                  <KeyRound className="w-3.5 h-3.5 text-amber-400" /> New
                  Password (Optional)
                </label>
                <input
                  type="password"
              ...
              {settingsForm.newPassword && (
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-amber-200 flex items-center gap-1.5">
                    <KeyRound className="w-3.5 h-3.5 text-amber-400" /> Confirm
                    New Password
                  </label>
                  <input
                    type="password"

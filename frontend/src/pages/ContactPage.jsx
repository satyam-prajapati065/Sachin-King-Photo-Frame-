...
import { Phone, Mail, MapPin, MessageCircle, Send, Sparkles, CheckCircle2 } from 'lucide-react';
...
export default function ContactPage() {
  ...
  const whatsappUrl = 'https://wa.me/917052668517?text=Hello%20Sachin%20King%20Photo%20Frame,%20I%20want%20to%20get%20in%20touch.';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('Failed to send message. Please try sending directly via WhatsApp.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
      ...
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        ...
        <p className="text-xs sm:text-sm text-amber-200/80 font-poppins leading-relaxed">
          Visit our workshop, call us, or send a quick message below for photo framing, devotional frames, and printing inquiries.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-6">
          <div className="p-6 rounded-2xl glass-card border border-amber-500/30 space-y-4">
            <h3 className="text-xl font-bold font-playfair text-amber-200">Business Details</h3>
            ...
            <div className="space-y-4 text-xs">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-bold text-amber-100 text-sm">Shop Address</h4>
                  <p className="text-amber-200/80 leading-relaxed mt-0.5">
                    Sachin King Photo Frame, Main Road Framing Hub, Uttar Pradesh - 273001, India
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-bold text-amber-100 text-sm">Call & WhatsApp Number</h4>
                  <a href={`tel:${phoneNumber}`} className="text-amber-300 font-semibold text-sm hover:underline block mt-0.5">
                    +91 7052668517
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-bold text-amber-100 text-sm">Official Email</h4>
                  <a href="mailto:sp073643@gmail.com" className="text-amber-300 font-semibold text-sm hover:underline block mt-0.5">
                    sp073643@gmail.com
                  </a>
                </div>
              </div>
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-r from-emerald-950 via-emerald-900 to-emerald-950 border border-emerald-500/40 space-y-3">
            <h4 className="text-lg font-bold text-emerald-200 font-playfair flex items-center gap-2">
              <MessageCircle className="w-5 h-5 text-emerald-400" /> Fast WhatsApp Inquiry
            </h4>
            <p className="text-xs text-emerald-100/80 leading-relaxed">
              Prefer instant messaging? Share your photo or frame requirements directly on WhatsApp for quick estimates.
            </p>
            <a
              href={whatsappUrl}
              target="_blank"
            ...
            >
              <MessageCircle className="w-4 h-4 fill-white" /> WhatsApp Chat (+91 7052668517)
            </a>
          </div>
        </div>
        ...
        <div className="p-8 rounded-3xl glass-card border border-amber-500/40 shadow-2xl space-y-6">
          <div className="space-y-1">
            <h3 className="text-2xl font-bold font-playfair text-amber-100">Send Us a Direct Message</h3>
            <p className="text-xs text-amber-200/70">Your message will be sent directly to the admin dashboard.</p>
          </div>

          {submitted ? (
            <div className="p-8 rounded-2xl bg-emerald-500/20 border border-emerald-500/40 text-center space-y-3">
              <CheckCircle2 className="w-12 h-12 text-emerald-400 mx-auto" />
              <h4 className="text-lg font-bold text-emerald-300 font-playfair">Message Sent Successfully!</h4>
              <p className="text-xs text-amber-200/80">
                Thank you for contacting Sachin King Photo Frame. We will reach out to you shortly.
              </p>
              <button
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-amber-300 font-medium mb-1">Email Address</label>
                  <input
                    type="email"
                    placeholder="sp073643@gmail.com"
              ...
              <div>
                <label className="block text-amber-300 font-medium mb-1">Your Message *</label>
                <textarea
                  rows="4"
                  required
      ...
      <div className="space-y-4">
        <div className="text-center">
          <h3 className="text-2xl font-bold font-playfair text-amber-100">Find Our Shop on Google Maps</h3>
          <p className="text-xs text-amber-200/70">Visit us for frame samples, mount board selection, and physical consultations</p>
        </div>
        ...
        <div className="rounded-3xl overflow-hidden border-2 border-amber-500/30 shadow-2xl h-[380px] bg-black">
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d113911.0841261314!2d83.33!3d26.76!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3991446a00000001%3A0x1!2sPhoto%20Framing!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen=""

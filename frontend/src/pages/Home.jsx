...
const heroSlides = [
  {
    image: 'https://images.unsplash.com/photo-1579783900882-c0d3dad7b119?auto=format&fit=crop&q=80&w=1920',
    heading: 'Royal & Classic Photo Framing',
    subheading: 'Preserve your precious moments with antique gold, synthetic & teakwood frames.'
  },
  {
    image: 'https://images.unsplash.com/photo-1609137144813-7d9921338f24?auto=format&fit=crop&q=80&w=1920',
    heading: 'Devotional God Frames with LED',
    subheading: 'Premium backlit god photo frames with velvet mounts for homes and offices.'
  },
  {
    image: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b675?auto=format&fit=crop&q=80&w=1920',
    heading: 'HD Canvas & Banner Printing',
    subheading: 'High resolution canvas stretchers, visiting cards, flex banners & customized gifts.'
  }
];
  ...
  return (
    <div className="space-y-20 pb-16">
      ...
      <section className="relative min-h-[480px] sm:min-h-[580px] h-[75vh] sm:h-[85vh] max-h-[800px] overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-3 sm:px-6 text-center space-y-3 sm:space-y-6 py-8 sm:py-12 flex flex-col items-center justify-center">
          ...
          >
            ...
            <span className="truncate">"Ek Hi Chhat Ke Neeche Sabhi Suvidhayein"</span>
          </motion.div>
          ...
          >
            ...
            >
              <Phone className="w-3 h-3 sm:w-4 sm:h-4 fill-slate-950 shrink-0" /> Call Now
            </a>
            ...
            >
              <MessageCircle className="w-3 h-3 sm:w-4 sm:h-4 fill-white shrink-0" /> WhatsApp
            </a>
            ...
            >
              Explore <ArrowRight className="w-3 h-3 sm:w-4 sm:h-4 text-amber-400 shrink-0" />
            </Link>
          </motion.div>
        </div>
          ...
          {heroSlides.map((_, idx) => (
            <button
              ...
              className={`h-1.5 sm:h-2 rounded-full transition-all ${
                currentSlide === idx ? 'w-6 sm:w-8 bg-amber-400' : 'w-1.5 sm:w-2 bg-amber-500/30'
              }`}
            />
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 bg-[#181822] border-2 border-amber-500/50 p-5 rounded-2xl shadow-2xl hidden sm:flex items-center gap-4 max-w-xs glass-card">
              ...
              <div>
                <h4 className="text-xl font-bold font-playfair text-amber-300">10+ Years</h4>
                <p className="text-xs text-amber-200/80">Crafting Unmatched Quality Frames & Prints</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-amber-400 bg-amber-500/10 px-3 py-1 rounded-full border border-amber-500/20">
              <Sparkles className="w-3.5 h-3.5" /> Welcome To Sachin King Photo Frame
            </div>
            ...
            <p className="text-sm text-amber-200/80 leading-relaxed font-poppins">
              At <strong className="text-amber-300">Sachin King Photo Frame</strong>, we turn your cherished memories into timeless art pieces. Whether it is a family portrait, a devotional god frame with LED lighting, high-definition canvas stretchers, visiting cards, or flex banners for your shop, we deliver precision craftsmanship at unbeatable local pricing.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="text-center space-y-3 max-w-2xl mx-auto">
            ...
            <p className="text-xs sm:text-sm text-amber-200/70">
              We combine artisan attention to detail with state-of-the-art printing machinery.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-6">
            {[
              ...
              >
                ...
                <h3 className="text-sm sm:text-lg font-bold font-playfair text-amber-200">{feature.title}</h3>
                <p className="text-[10px] sm:text-xs text-amber-200/70 leading-normal sm:leading-relaxed font-poppins">{feature.desc}</p>
              </div>
            ))}
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 border-b border-amber-500/30 pb-4">
          <div>
            <span className="text-xs font-bold uppercase tracking-widest text-amber-400 bg-amber-500/10 px-3 py-1 rounded-full border border-amber-500/20 inline-flex items-center gap-1.5">
              <Frame className="w-3.5 h-3.5 text-amber-400" /> Photo Framing & Lamination
            </span>
            ...
            <p className="text-xs text-amber-200/70 mt-1 font-poppins">
              Classic wooden frames, devotional God photo frames with LED, wedding portraits & matte/gloss photo lamination.
            </p>
          </div>
          <Link
            to="/services"
        ...
        {loading ? (
          <div className="py-8 text-center text-amber-400">Loading Framing Services...</div>
        ) : (
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2.5 sm:gap-6">
            {services
              .filter((s) => {
                ...
                if (name.includes('office') || name.includes('gift') || name.includes('insurance') || name.includes('customized')) return false;
                return name.includes('frame') || name.includes('lamination') || cat.includes('framing') || cat.includes('religious') || cat.includes('decor');
              })
              .map((service) => (
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 border-b border-amber-500/30 pb-4">
          <div>
            <span className="text-xs font-bold uppercase tracking-widest text-amber-400 bg-amber-500/10 px-3 py-1 rounded-full border border-amber-500/20 inline-flex items-center gap-1.5">
              <Printer className="w-3.5 h-3.5 text-amber-400" /> HD Printing & Advertising
            </span>
            <h2 className="text-2xl sm:text-3xl font-bold font-playfair text-amber-100 mt-2">
              Printing & Banner Services
            </h2>
            <p className="text-xs text-amber-200/70 mt-1 font-poppins">
              Canvas stretchers, flex banners, pamphlets, visiting cards, bill books, and royal wedding invitation cards.
            </p>
          </div>
          <Link
            to="/services"
        ...
        {loading ? (
          <div className="py-8 text-center text-amber-400">Loading Printing Services...</div>
        ) : (
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2.5 sm:gap-6">
            {services
              .filter((s) => {
                const name = (s.name || '').toLowerCase();
                const cat = (s.category || '').toLowerCase();
                return name.includes('print') || name.includes('banner') || name.includes('card') || name.includes('bill') || name.includes('pamphlet') || name.includes('handbill') || name.includes('poster') || cat.includes('printing');
              })
              .map((service) => (
                <ServiceCard key={service.id} service={service} />
              ))}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 border-b border-amber-500/30 pb-4">
          <div>
            <span className="text-xs font-bold uppercase tracking-widest text-amber-400 bg-amber-500/10 px-3 py-1 rounded-full border border-amber-500/20 inline-flex items-center gap-1.5">
              <Gift className="w-3.5 h-3.5 text-amber-400" /> Custom Gifts & Utilities
            </span>
            <h2 className="text-2xl sm:text-3xl font-bold font-playfair text-amber-100 mt-2">
              Custom & Special Services
            </h2>
            <p className="text-xs text-amber-200/70 mt-1 font-poppins">
              Customized frame sizing, photo gift items, office certificate framing, and vehicle insurance assistance.
            </p>
          </div>
          <Link
            to="/services"
        ...
        {loading ? (
          <div className="py-8 text-center text-amber-400">Loading Custom Services...</div>
        ) : (
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2.5 sm:gap-6">
            {services
              .filter((s) => {
                const name = (s.name || '').toLowerCase();
                const cat = (s.category || '').toLowerCase();
                return name.includes('office') || name.includes('gift') || name.includes('insurance') || name.includes('custom') || cat.includes('corporate') || cat.includes('gifts') || cat.includes('services');
              })
              .map((service) => (
                <ServiceCard key={service.id} service={service} />
              ))}
            ...
            >
              ...
              <div className="flex items-center gap-2 sm:gap-3 pt-2 sm:pt-4 border-t border-amber-500/15">
                ...
                <div>
                  ...
                  <span className="text-[8px] sm:text-[10px] text-amber-400/70 block">Verified Buyer</span>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-r from-amber-950 via-amber-900 to-amber-950 border border-amber-500/40 text-center space-y-6 shadow-2xl gold-glow relative overflow-hidden">
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-amber-200/80 max-w-xl mx-auto font-poppins">
              Send your photo or frame dimension requirements directly to our master artisan Sachin ji and receive an instant estimate.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            ...
            >
              <MessageCircle className="w-4 h-4 fill-white" /> WhatsApp +91 7052668517
            </a>
